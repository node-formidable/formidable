...
export function json(formidable, options) {
  ...
  if (/json/iu.test(self.headers['content-type'])) {
    // eslint-disable-next-line prefer-reflect
    pluginInitialize.call(self, self, options);
  }
...
function pluginInitialize(_self, _opts) {
  this.type = jsonType;
