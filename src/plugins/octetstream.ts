...
import OctetStreamParser from '../parsers/OctetStream';
...
function init(this: Formidable, _self: Formidable, _opts: IFormidableOptions) {
  ...
  const thisPart = {
    ...[Array.isArray(originalFilename) ? originalFilename[0] : originalFilename],
    mimetype,
  };
  ...
  const file = this._newFile({
    newFilename,
    filepath,
    ...{originalFilename: Array.isArray(originalFilename) ? originalFilename[0] : originalFilename},
    mimetype,
  });
