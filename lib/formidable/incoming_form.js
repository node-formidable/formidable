...
function IncomingForm(options) {
  ...
  this.uploadDir = options.uploadDir || '/tmp';
  this.encoding = options.encoding || 'utf-8';
  this.bindAsList = options.bindAsList || [];
  this.bindAllAsList = options.bindAllAsList || false;
  this.headers = null;
  this.type = null;
  ...
  if (cb) {
    ...
    this
      .addListener('field', function(name, value) {
        if (self.bindAllAsList || self.bindAsList.indexOf(name) >= 0) {
